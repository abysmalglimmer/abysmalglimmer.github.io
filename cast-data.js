window.CastData = {
  ...
  contestants: {
    ...
    "jaison-robinson":   { name: "Jaison Robinson",   bio: "" },
        ...
        // ── S21 Nicaragua ───────────────────────────────────────────────────
    "fabio-birza":        { name: "Fabio Jud Birza",    bio: "The penny didn't really drop for me that he was winning until the penultimate episode. But yeah, what can I say? He's so much fun, I like watching him, and he's the perfect winner for such an oddball season." },
    "chase-rice":         { name: "Chase Rice",         bio: "Chase belongs to an Survivor archetype of the good-looking but (endearingly) neurotic and paranoid guy. Other members of this archetype include Jamie Newton (Guatemala) and Dan Kay (Gabon) who I also really liked. Unlike those guys though, Chase makes it really far and comes a hair away from winning - probably more a testament to the chaos of the season than a reflection on Chase's social game." },
    "sash-lenahan":       { name: "Sash Lenahan",       bio: "Probst makes a really weird comment to Sash during the reunion. He says something along the lines of, 'I apologise to you Sash for telling you throughout casting that you would be the first out.' What?? Anyway, I guess Sash is the nerdy guy Survivor fan self-insert of the season. I felt a bit bad that he received zero votes... I thought for sure he had pissed off fewer people than Chase." },
    "holly-hoffman":      { name: "Holly Hoffman",      bio: "I'm noticing an archetype of character who is on-the-ropes in the early game (often from being allied with an early out) but gets a positive edit and somehow limps their way into the late game. I could immediately tell Holly was one of these, but I enjoyed her a lot more than the previous iteration of this character, Erinn Lobdell (Tocantins)." },
    "jane-bright":        { name: "Jane Bright",        bio: "I really want to know why Marty hated her ass so bad.\n\nShe was sweet, strong, and when it came to it, she stood on business. What an icon." },
    "dan-lembo":          { name: "Dan Lembo",          bio: "" },
    "benry-henry":        { name: "Benry Henry",        bio: "So he's called Benry because his full name is Ben Henry. I think that's probably the most interesting thing about him." },
    "naonka-mixon":       { name: "NaOnka Mixon",       bio: "I genuinely belived that NaOnka was winning this season - or at least making it to Final Tribal. In the reunion Probst describes her as a 'villain' but she was quite literally the narrator on La Flora for the entire early game. Given how much Probst and the show likes to moralise about quitters, I think it's surprising how positively she is protrayed, but thank god they do so because she is really the heart and soul of the season." },
    "purple-kelly":       { name: "Purple Kelly Shinn",        bio: "" },
    "marty-piombo":       { name: "Marty Piombo",       bio: "Alongside NaOnka, he is the other clear main character. After several near misses (none of which I seriously believed would get him out, because of his edit), he gets his torch snuffed quite early in the merged tribe, which surprised me greatly. With NaOnka's subsequent quit, it sort of leaves the season without a main character - which worked pretty well." },
    "alina-wilson":       { name: "Alina Wilson",       bio: "" },
    "brenda-lowe":        { name: "Brenda Lowe",        bio: "Brenda was probably the third main character of the pre-merge. Again, it was very surprising to see her taken out almost unceremoniously in a single episode." },
    "yve-rojas":          { name: "Yve Rojas",          bio: "" },
    "jimmy-johnson":          { name: "Jimmy Johnson",      bio: "You will NEVER be Coach." },
    ...
    "david-murphy":        { name: "David Murphy",        bio: "Picking three favourites for this season was honestly pretty tough. I guess David had promise... he was a weird little guy, and I liked that." },
    "julie-wolfe":         { name: "Julie Wolfe",         bio: "" },
    "steve-wright":        { name: "Steve Wright",        bio: "" },
    "ralph-kiser":         { name: "Ralph Kiser",         bio: "" },
    "grant-mattos":        { name: "Grant Mattos",        bio: "So, this guy is clearly not really a relevant character - like the entire cast. I just want to call him out quickly. In episode 10, Grant talks about being 'uncomfortable' that Phillip brings up 'the race card' and uses the n-word. But Grant. You are a white man with dreadlocks. Come on, bro. Have some class." },
    ...
    "alicia-rosa":        { name: "Alicia Rosa",          bio: "Alicia's confessionals were the highlight of the season. Out of the women, probably the only properly interesting character - because some level of divisiveness is needed to make it as a reality TV star. Perhpaps she inched towards cruelty at times, especially with regards to Christina, but never fully turned me off her. (Unlike Colton, her partner in crime.)" },
    "kat-edorsson":       { name: "Kat Edorsson",         bio: "Kat is a pretty unique character I think. She's young, immature, a bit ditzy, but her kind and genuine energy shone through. The blindside on her and her devastated reaction was one of the more interesting parts of the season." },
    "tarzan-smith":       { name: "Tarzan Smith",         bio: "I'm not really a fan of his saying-big-words, weird-guy shtick. On his very last episode we finally got some game-playing out of him, but it was too little too late. (And the plan didn't work.)" },
    ...
    "lisa-whelchel":       { name: "Lisa Whelchel",       bio: "One of the strongest stories ever told on Survivor! It's rare to see such character development on a reality TV show." },
    "malcolm-freberg":     { name: "Malcolm Freberg",     bio: "Malcolm is a pretty typical Survivor guy, but we spend a lot of time with him and I like him a lot." },
    "abi-maria-gomes":     { name: "Abi-Maria Gomes",     bio: "Abi is just... so nasty! And paranoid. And aggressive. And rude! But I honestly grew to really love her. She felt totally authentic to herself and, in an almost autistic kind of way, I don't think she ever meant to hurt anybody. Plus she makes for excellent TV." },
    "pete-yurkowski":      { name: "Pete Yurkowski",      bio: "I found him kind of annoying and ugly at first, not going to lie. But as the season went on, I grew to appreciate his personality, villainousness, and his face. He does potentially get a bit overshadowed by public enemy number 1 (Abi-Maria), but he makes for an excellent scheming mastermind through the mid-season, and I do think he had more to offer." },
    "artis-silvester":     { name: "Artis Silvester",     bio: "" },
    "jeff-kent":           { name: "Jeff Kent",           bio: "" },
    "rc-saint-amour":      { name: "R.C. Saint-Amour",    bio: "RC was my early pick for a top contender. Unfortunately, I was misled. She was really smart and well-spoken." },
    "katie-hanson":        { name: "Katie Hanson",        bio: "" },
    "dana-lambert":        { name: "Dana Lambert",        bio: "" },
    "angie-layton":        { name: "Angie Layton",        bio: "" },
    "roxy-morris":         { name: "Roxanne 'Roxy' Morris", bio: "Taken from us too soon!" },
    ...
    },
  {
    ...
    },
    {
      ...
      cast: [
        ...
        { id: "jim-rice",          placement: 11, jury: true, starting_tribe: "Savaii" },
        { id: "keith-tollefson",   placement: 12, jury: true, starting_tribe: "Savaii" },
